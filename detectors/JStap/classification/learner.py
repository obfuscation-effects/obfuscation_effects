...
def parsing_commands():
    ...
    parser.add_argument('--d', metavar='DIR', type=str, nargs='+',
                        default=['/root/JS_Detector/Detectors/JStap/samples/Good-train/Analysis/PDG',
                                 '/root/JS_Detector/Detectors/JStap/samples/Bad-train/Analysis/PDG'],
    ...
    parser.add_argument('--vd', metavar='DIR-VALIDATE', type=str, nargs='+',
                        default=['/root/JS_Detector/Detectors/JStap/samples/Good-validate/Analysis/PDG',
                                 '/root/JS_Detector/Detectors/JStap/samples/Bad-validate/Analysis/PDG'],
    ...
    parser.add_argument('--md', metavar='MODEL-DIR', type=str, nargs=1,
                        default=[os.path.join('/root/JS_Detector/Detectors/JStap/samples/result_debug', 'Analysis')],
